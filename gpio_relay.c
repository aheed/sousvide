/*
  ...
  * 
  * AH20151031: Downloaded this example from http://www.susa.net/wordpress/2012/06/raspberry-pi-relay-using-gpio/
  */
...
//      printf(" GPIO 17 is %s\n", (GPLEV0 & BIT_17) ? "high" : "low");
      ...
      for (loopcnt = 0; loopcnt < MEAS_INTERVAL_SECONDS; loopcnt++)
      {
